...
var et = (t, e, n) =>
  e in t
    ? tt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
    : (t[e] = n);
    ...
    const c = e[s].claim_order,
      _ =
        (l > 0 && e[n[l]].claim_order <= c
          ? l + 1
          : ft(1, l, (m) => e[n[m]].claim_order, c)) - 1;
    a[s] = n[_] + 1;
    const u = _ + 1;
...
function vt(t, e, { bubbles: n = !1, cancelable: a = !1 } = {}) {
...
`;
  ...
  const _ =
    ...
    m = J(t),
    { stylesheet: p, rules: f } = B.get(m) || bt(m, t);
  f[u] ||
    ((f[u] = !0), p.insertRule(`@keyframes ${u} ${_}`, p.cssRules.length));
  const d = t.style.animation || "";
  return (
    (t.style.animation = `${
      d ? `${d}, ` : ""
    }${u} ${a}ms linear ${l}ms 1 both`),
    (D += 1),
    u
  );
}
...
function Yt(t, e, n) {
  ...
  function c() {
    ...
    const d = M() + _,
      h = d + u;
    S(() => v(t, !1, "start")),
      "inert" in t && ((s = t.inert), (t.inert = !0)),
      q(($) => {
        if (o) {
...
function Zt(t, e, n, a) {
  ...
  function p(f) {
    ...
    f || ((b.group = y), (y.r += 1)),
      "inert" in t &&
        (f ? _ !== void 0 && (t.inert = _) : ((_ = t.inert), (t.inert = !0))),
      i || s
        ? (s = b)
        : (x && (u(), (c = I(t, r, f, h, d, $, x))),
          f && g(0, 1),
          ...
          q((j) => {
            if (
              (s &&
                ...
                (s = null),
                v(t, i.b, "start"),
                x && (u(), (c = I(t, r, i.b, i.duration, 0, $, o.css)))),
              i)
            ) {
              if (j >= i.end)
                g((r = i.b), 1 - r),
                  v(t, i.b, "end"),
                  s || (i.b ? u() : --i.group.r || E(i.group.c)),
                  (i = null);
              else if (j >= i.start) {
                const Z = j - i.start;
...
function Ct(t, e) {
  t.$$.dirty[0] === -1 && (lt.push(t), ct(), t.$$.dirty.fill(0)),
    ...
    ((c.ctx = n
      ? n(t, e.props || {}, (u, m, ...p) => {
          ...
          return (
            c.ctx &&
              l(c.ctx[u], (c.ctx[u] = f)) &&
              (!c.skip_bound && c.bound[u] && c.bound[u](f), _ && Ct(t, u)),
            m
          );
        })
      : []),
